...
export const useKugouUserStore = defineStore('kugouUser', {
    state: () => ({
        ...
        playlists: JSON.parse(localStorage.getItem('kugou_user_playlists') || '[]'),
        likedPlaylistId: localStorage.getItem('kugou_liked_playlist_id') || '',
        likedSongsHashes: JSON.parse(localStorage.getItem('kugou_liked_songs_hashes') || '[]'),  // 已喜欢歌曲的 hash 集合(用于快速判断 isLiked)
        vipInfo: null,
        logining: false,
        loginMessage: ''
    }),
    actions: {
        ...
        async fetchUserPlaylists() {
            ...
            try {
                ...
                localStorage.setItem('kugou_user_playlists', JSON.stringify(this.playlists))
                ...
                if (this.likedPlaylistId) {
                    localStorage.setItem('kugou_liked_playlist_id', this.likedPlaylistId)
        ...
        logout() {
            ...
            localStorage.removeItem('kugou_user_playlists')
            localStorage.removeItem('kugou_liked_playlist_id')
            localStorage.removeItem('kugou_liked_songs_hashes')
            this.vipInfo = null
        ...
        async toggleLikeSong(song) {
            ...
            try {
                ...
                if (isLiked) {
                    ...
                    localStorage.setItem('kugou_liked_songs_hashes', JSON.stringify(this.likedSongsHashes))
        ...
        async fetchLikedSongs() {
            ...
            try {
                ...
                localStorage.setItem('kugou_liked_songs_hashes', JSON.stringify(allHashes))
